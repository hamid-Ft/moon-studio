...
export const members: MemberProfile[] = [
	{
		...
		responsibility: {
			en: "Cross-platform retail delivery across POS, kiosks, payments, credit and BNPL, ERP, and operational control surfaces.",
			fa: "تحویل چندسکویی محصولات خرده‌فروشی؛ از POS، کیوسک، پرداخت و خرید اعتباری تا ERP و مرکز کنترل عملیات.",
		},
		summary: {
			en: "Building Moonlancer with friends since 2023 as a side venture, alongside durable React and Next.js products and efficient Rust and Tauri store-edge applications across Linux, Windows, and Android.",
			fa: "از سال ۲۰۲۳ Moonlancer را همراه دوستانش به‌عنوان یک مسیر جانبی می‌سازد و در کنار آن محصولات پایدار React و Next.js و اپلیکیشن‌های سبک Rust و Tauri را برای Linux، Windows و Android توسعه می‌دهد.",
		},
		systemTypes: {
			en: [
				"Custom POS and offline store applications",
				"Payment, credit, and BNPL journeys",
				"Self-service kiosks and retail control centers",
			],
			fa: [
				"اپلیکیشن اختصاصی POS و فروش آفلاین",
				"جریان پرداخت، اعتبار و خرید اقساطی",
				"کیوسک سلف‌سرویس و مرکز کنترل خرده‌فروشی",
			],
		},
		technicalRange: [
			"Rust",
		...
		deliveryRemit: {
			en: [
				"Retail product and interface architecture",
				"Rust and Tauri edge-app delivery",
				"Payment, ERP, and peripheral integration",
				"Cross-platform release and recovery QA",
			],
			fa: [
				"معماری محصول و رابط خرده‌فروشی",
				"تحویل اپلیکیشن لبه با Rust و Tauri",
				"اتصال پرداخت، ERP و تجهیزات جانبی",
				"تست انتشار و بازیابی چندسکویی",
			],
		},
		cvHistory: {
			en: [
				"Co-founded Moonlancer with friends in 2023 as a side venture for connected retail, POS, payment, BNPL, kiosk, and store-operations products.",
			...
			fa: [
				"راه‌اندازی Moonlancer همراه دوستان در سال ۲۰۲۳ به‌عنوان یک مسیر جانبی برای محصولات یکپارچه خرده‌فروشی، POS، پرداخت، خرید اعتباری، کیوسک و عملیات فروشگاه.",
