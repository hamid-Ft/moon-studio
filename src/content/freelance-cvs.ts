...
export const freelanceCVs: Record<FreelanceSlug, FreelanceCV> = {
	'hamid-ft': {
		...
		role: {
			en: 'Cross-platform Product Developer & Moonlancer Co-founder',
			fa: 'توسعه‌دهنده محصولات چندسکویی و هم‌بنیان‌گذار Moonlancer',
		},
		intro: {
			en: 'I design and build operational products across web, desktop, and Android. Since 2023, I have also been building Moonlancer with friends as a side venture focused on custom retail software: POS, payment, credit and BNPL journeys, self-service kiosks, and back-office control. I use React and Next.js for web products and Rust with Tauri for secure, efficient store-edge applications.',
			fa: 'محصولات عملیاتی را برای وب، دسکتاپ و اندروید طراحی و پیاده‌سازی می‌کنم. از سال ۲۰۲۳ نیز Moonlancer را همراه دوستانم به‌عنوان یک مسیر جانبی ساخته‌ام؛ با تمرکز بر نرم‌افزار اختصاصی خرده‌فروشی، شامل POS، پرداخت، اعتبار و خرید اقساطی، کیوسک سلف‌سرویس و کنترل بک‌آفیس. برای محصولات وب از React و Next.js و برای اپلیکیشن‌های امن و سبک لبه فروشگاه از Rust و Tauri استفاده می‌کنم.',
		},
		portrait: {
			src: '/hamid-ft.png',
			alt: {
		...
		services: {
			en: [
				'Custom POS and offline-first store applications',
				'Payment, wallet, credit, and BNPL product flows',
				'Self-service kiosk and assisted checkout interfaces',
				'Retail control centers, ERP integration, and device operations',
			],
			fa: [
				'اپلیکیشن اختصاصی POS با عملکرد آفلاین',
				'جریان‌های پرداخت، کیف پول، اعتبار و خرید اقساطی',
				'رابط کیوسک سلف‌سرویس و صندوق کمکی',
				'مرکز کنترل فروشگاه، اتصال ERP و مدیریت دستگاه‌ها',
			],
		},
		platform: {
			kicker: {
				en: 'Cross-platform retail delivery',
				fa: 'تحویل چندسکویی برای خرده‌فروشی',
			},
			title: {
				en: 'One product family. Every retail surface.',
				fa: 'یک خانواده محصول برای تمام نقاط فروش.',
			},
			intro: {
				en: 'Through Moonlancer, I shape a shared product language for cashiers, customers, store managers, and central operations without forcing every device into the same interface.',
				fa: 'در Moonlancer یک زبان محصول مشترک برای صندوقدار، مشتری، مدیر شعبه و تیم عملیات مرکزی شکل می‌دهم، بدون اینکه همه دستگاه‌ها را مجبور به استفاده از یک رابط یکسان کنم.',
			},
			products: [
				{
					name: { en: 'POS & store edge', fa: 'POS و لبه فروشگاه' },
					detail: {
						en: 'Offline-aware checkout, local device control, peripherals, updates, and recovery.',
						fa: 'فروش آفلاین، کنترل محلی دستگاه، تجهیزات جانبی، به‌روزرسانی و بازیابی.',
					},
					runtime: 'Rust + Tauri · Linux / Windows / Android',
				},
				{
					name: { en: 'Payments & BNPL', fa: 'پرداخت و خرید اعتباری' },
					detail: {
						en: 'Payment, wallet, credit, installment, refund, settlement, and exception flows.',
						fa: 'جریان پرداخت، کیف پول، اعتبار، اقساط، بازپرداخت، تسویه و مدیریت خطا.',
					},
					runtime: 'React + TypeScript · POS / Web / Mobile',
				},
				{
					name: { en: 'Self-service kiosk', fa: 'کیوسک سلف‌سرویس' },
					detail: {
						en: 'Touch-first catalog, ordering, payment, accessibility, and assisted recovery.',
						fa: 'کاتالوگ لمسی، سفارش، پرداخت، دسترس‌پذیری و بازیابی با کمک اپراتور.',
					},
					runtime: 'Tauri · Linux / Windows / Android',
				},
				{
					name: { en: 'Operations control', fa: 'کنترل عملیات' },
					detail: {
						en: 'Store and device health, inventory, rollout, reporting, and ERP workflows.',
						fa: 'سلامت شعب و دستگاه، موجودی، انتشار نسخه، گزارش‌گیری و گردش‌کار ERP.',
					},
					runtime: 'Next.js · Web control center',
				},
			],
		},
		location: {
		...
		skills: [
			{
				title: {
					en: 'Cross-platform Core',
					fa: 'هسته چندسکویی',
				},
				items: ['Rust', 'Tauri', 'TypeScript', 'React', 'Next.js', 'JavaScript'],
			},
			{
				title: {
					en: 'Platform Targets',
					fa: 'سیستم‌عامل‌های هدف',
				},
				items: ['Linux', 'Windows', 'Android', 'Web', 'Desktop', 'Offline-first'],
			},
			{
				title: {
					en: 'Retail Systems',
					fa: 'سیستم‌های خرده‌فروشی',
				},
				items: ['POS', 'Kiosk', 'Payments', 'Credit & BNPL', 'ERP Panels', 'Device Operations'],
			},
			{
				title: {
				...
				items: ['Tailwind CSS', 'Shadcn UI', 'Figma', 'React Query', 'API Integration', 'Git'],
			},
		],
		experience: [
			{
				...
				role: {
					en: 'Co-founder & Cross-platform Product Developer',
					fa: 'هم‌بنیان‌گذار و توسعه‌دهنده محصولات چندسکویی',
				},
				period: {
					en: '2023 - Present',
					fa: '۲۰۲۳ تا اکنون (میلادی)',
				},
				arrangement: {
					en: 'Side Venture · With friends',
					fa: 'مسیر جانبی · همراه دوستان',
				},
				summary: {
					en: 'Co-founded Moonlancer with friends as an independent side venture. I lead its retail product direction and build the delivery foundation for custom POS, payment, credit and BNPL, self-service kiosk, ERP integration, and operational control products across web, Linux, Windows, and Android.',
					fa: 'Moonlancer را همراه دوستانم به‌عنوان یک مسیر جانبی مستقل راه‌اندازی کردم. هدایت محصول خرده‌فروشی و ساخت زیرساخت تحویل برای POS اختصاصی، پرداخت، اعتبار و خرید اقساطی، کیوسک سلف‌سرویس، اتصال ERP و محصولات کنترل عملیات روی وب، Linux، Windows و Android را بر عهده دارم.',
				},
			},
			{
				company: {
			...
			},
			{
				...
				period: {
					en: 'December 2022 - September 2024',
					fa: 'دسامبر 2024 تا سپتامبر 2022 (میلادی)',
				},
				arrangement: {
					en: 'Full-Time',
					fa: 'تمام‌وقت',
			...
			},
			{
				...
				period: {
					en: 'November 2018 - December 2021',
					fa: 'نوامبر 2018 تا دسامبر 2021 (میلادی)',
				},
				arrangement: {
					en: 'Agency',
					fa: 'آژانس',
		...
		projects: [
			{
				name: 'Moonlancer',
				summary: {
					en: 'A side venture co-founded with friends to create connected software for large retailers: store-edge POS, payment and credit/BNPL journeys, self-service kiosks, ERP and inventory integration, and central operations.',
					fa: 'مسیر جانبی مشترک با دوستان برای ساخت نرم‌افزار یکپارچه خرده‌فروشی‌های بزرگ؛ شامل POS لبه فروشگاه، جریان پرداخت و خرید اعتباری، کیوسک سلف‌سرویس، اتصال ERP و موجودی و عملیات مرکزی.',
				},
				stack: 'Rust / Tauri / React / Next.js / TypeScript / Linux / Windows / Android',
				href: 'https://moonlancer.ir',
			},
			{
