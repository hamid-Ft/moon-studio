...
> = {
	en: {
		privacy: {
			...
			intro: 'This notice explains how the founder-operated Moonlancer website handles project inquiries and basic site measurement.',
			updated: 'Last updated: 3 August 2026',
			sections: [
				{
					title: 'Operator and contact',
					paragraphs: [
						'Hamid Fattahi operates this website and is the commercial contact for Moonlancer inquiries. Questions, correction requests, or deletion requests can be sent to hamidfattahi.a@gmail.com',
					],
				},
				{
				...
				},
				{
					...
					paragraphs: [
						'Moonlancer does not sell inquiry data. Information is shared only with service providers needed to operate the site and respond, or when required by law. You may ask for access, correction, or deletion by emailing hamidfattahi.a@gmail.com.',
					],
				},
			],
		},
		terms: {
			title: 'Website terms',
			intro: 'These interim terms govern use of the Moonlancer website. Any paid engagement requires a separate written agreement.',
			updated: 'Last updated: 3 August 2026',
			sections: [
				{
	...
	fa: {
		privacy: {
			...
			intro: 'این اطلاعیه توضیح می‌دهد وب‌سایت بنیان‌گذارمحور Moonlancer چگونه درخواست‌های پروژه و اندازه‌گیری پایه سایت را پردازش می‌کند.',
			updated: 'آخرین به‌روزرسانی: ۱۲ مرداد ۱۴۰۵',
			sections: [
				{
					title: 'مسئول و راه تماس',
					paragraphs: [
						'حمید فتاحی این وب‌سایت را اداره می‌کند و راه تماس تجاری درخواست‌های Moonlancer است. پرسش، اصلاح یا درخواست حذف اطلاعات را به hamidfattahi.a@gmail.com ارسال کنید.',
					],
				},
				{
				...
				},
				{
					...
					paragraphs: [
						'Moonlancer اطلاعات درخواست را نمی‌فروشد. اطلاعات فقط با ارائه‌دهندگان لازم برای اداره سایت و پاسخ یا در صورت الزام قانونی به اشتراک گذاشته می‌شود. برای دسترسی، اصلاح یا حذف به hamidfattahi.a@gmail.com ایمیل بزنید.',
					],
				},
			],
		},
		terms: {
			...
			intro: 'این شرایط موقت استفاده از وب‌سایت Moonlancer را مشخص می‌کند. هر همکاری پولی به توافق مکتوب جداگانه نیاز دارد.',
			updated: 'آخرین به‌روزرسانی: ۱۲ مرداد ۱۴۰۵',
			sections: [
				{
					title: 'هدف وب‌سایت',
